# java-backend
A complete roadmap and curated resources to learn Java backend development including Java, Spring Boot, REST APIs, databases, microservices, and system design.


# Java-Backend 

In this repository, you will find :
  - [A small structured roadmap for learning Backend code with Java](#roadmap)
  - [A few resources for learning Java-Backend](#resources-for-learning-java-backend)
    - [Docs & Articles](https://github.com/abdmohanta/Java-Backend#docs--articles)
    - [Projects](https://github.com/abdmohanta/Java-Backend#projects)
    - [Helpful Links](https://github.com/abdmohanta/Java-Backend#helpful-links)
    - [Interview Questions](https://github.com/abdmohanta/Java-Backend#interview-questions)
  - [References of the roadmap](#references-of-the-roadmap)
  - Do not make any changes, if required just comment will update.
